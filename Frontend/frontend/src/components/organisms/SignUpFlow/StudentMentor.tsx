...
const StudentMentor : React.FC<IStudentMentor> = ({incrementStage, decrementStage}) => {

    const {userType, setUserType} = useContext(AccountContext)
          ...
          >
            ...
            <Box component="form" noValidate  sx={{ m: 4}}>
                ...
                <Box sx={{x:20}}>
                    ...
                    <Button onClick={incrementStage} sx={{p:4}} endIcon={<ArrowForwardIcon />}>Next</Button>
                </Box>
          </Box>
        </Grid>
    )
